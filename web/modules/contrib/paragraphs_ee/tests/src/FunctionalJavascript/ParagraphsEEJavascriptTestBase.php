...
abstract class ParagraphsEEJavascriptTestBase extends WebDriverTestBase {
   ...
   *   Use off-canvas instead of modal. Defaults to <code>FALSE</code>.
   */
  protected function createTestConfiguration($content_type, $num_of_test_paragraphs = 1, $off_canvas = FALSE) {
