...
class SearchApiExcludeEntityProcessorTest extends UnitTestCase {
   ...
   */
  protected SearchApiExcludeEntityProcessor $processor;
   ...
   * @var string
   */
  protected string $fieldName1 = 'field_exclude_1';
   ...
   * @var string
   */
  protected string $fieldName2 = 'field_exclude_2';
   ...
   */
  protected FieldItemListInterface $excludeEnabledValue;
   ...
   * @var \Drupal\Core\Field\FieldItemListInterface
   */
  protected FieldItemListInterface $excludeDisabledValue;
   ...
   * @param \Drupal\Core\Field\FieldItemListInterface|null $field_value_1
   *   (Optional) The value of the first exclude field of the mock node.
   * @param \Drupal\Core\Field\FieldItemListInterface|null $field_value_2
   *   (Optional) The value of the second exclude field of the mock node.
   *
   * @return \Drupal\search_api\Item\ItemInterface
   *   The mock search index item.
   */
  protected function createMockItem(string $bundle, string $raw_id, ?FieldItemListInterface $field_value_1 = NULL, ?FieldItemListInterface $field_value_2 = NULL): ItemInterface {
   ...
   */
  public function testAlterIndexedItems(): void {
