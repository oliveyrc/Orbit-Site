...
$start = new DateTime($argv[1] ?? "2025-01-01 00:00:00", $utc);
...
$skipHeaders = FALSE;
if (file_exists('statistics.csv')) {
  $skipHeaders = TRUE;
  print "📊 Skipping writing headers to statistics.csv since cached file exists.\n";
}

$statistics = fopen('statistics.csv', 'a');

if ($skipHeaders === FALSE) {
  print "📊 Writing headers to statistics.csv since file does not exist yet implying a full run.\n";
  fputcsv($statistics, [
    'date',
    'when',
    'overall',
